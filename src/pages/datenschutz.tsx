import { motion, useSpring, useTransform, useViewportScroll, MotionValue } from 'framer-motion';
...
const Datenschutz: React.FC<PageProps> = () => {
    ...
    useEffect(() => {
        ...
        if (wrapperElement) {
            mainclientheight = wrapperElement.clientHeight;
        }
